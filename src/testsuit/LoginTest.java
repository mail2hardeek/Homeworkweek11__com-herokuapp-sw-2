...
public class LoginTest extends BaseTest {
    ...
    public void userShouldLoginSuccessfullyWithValidCredentials() {
        ...
        WebElement emailField = dri.findElement(By.name("username"));
        ...
        dri.findElement(By.xpath("//button[@class = 'radius' and @type='submit']")).click();
    }
    ...
    public void verifyUsernameErrorMessage() {
        ...
        WebElement actualTextElement = dri.findElement(By.xpath("//h4[@class='subheader']"));
    ...
    public void verifyTheUsernameErrorMessage() {
        ...
        WebElement actualTextElement = dri.findElement(By.xpath("//div[@id ='flash']"));
